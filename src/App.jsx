...
export default function App() {
  ...
  const translateSubcategory = (subcategory) => {
    ...
    const translations = {
      ...
      'laptop stands': 'Bases para Portátil',
      'cleaning kits': 'Kits de Limpieza',
      
      // Storage
      'flash drives': 'Memorias USB',
      'external hard drives': 'Discos Duros Externos',
      'internal hard drives': 'Discos Duros Internos',
      'ssd drives': 'Unidades SSD',
      ...
      'security cables': 'Cables de Seguridad',
      'camera accessories': 'Accesorios para Cámaras',
      ...
      'cooling systems': 'Sistemas de Enfriamiento',
      ...
      'gaming headsets': 'Audífonos Gamer',
      'gaming chairs': 'Sillas Gamer',
      ...
      'thermal printers': 'Impresoras Térmicas',
      'label printers': 'Impresoras de Etiquetas',
      
      // Mobile Accessories
      'phone cases': 'Fundas para Teléfono',
      'screen protectors': 'Protectores de Pantalla',
      'chargers': 'Cargadores',
      'power banks': 'Bancos de Energía',
      'car chargers': 'Cargadores de Carro',
      'wireless chargers': 'Cargadores Inalámbricos',
      ...
      'monitors': 'Monitores',
      'webcams': 'Cámaras Web',
      'drawing tablets': 'Tabletas Gráficas',
      
      // POS
      'barcode scanners': 'Lectores de Código',
      'receipt printers': 'Impresoras de Recibos',
      'cash drawers': 'Cajones de Dinero',
      'pos terminals': 'Terminales POS',
      
      // Power & Electrical
      'ups systems': 'Sistemas UPS',
      ...
      // Tablets
      'android tablets': 'Tablets Android',
      'windows tablets': 'Tablets Windows',
      'tablet accessories': 'Accesorios para Tablets',
      
      // TV Accessories
      'tv mounts': 'Soportes para TV',
      'hdmi cables': 'Cables HDMI',
      'streaming devices': 'Dispositivos de Streaming',
      'tv antennas': 'Antenas de TV',
      
      // Video
      'video adapters': 'Adaptadores de Video',
      'hdmi splitters': 'Divisores HDMI',
      'video converters': 'Convertidores de Video',
      'capture cards': 'Capturadoras de Video'
    };
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const message = `🛒 Nueva Solicitud de Cotización\n\n👤 Cliente: ${clientData.nombre}\n📦 Total de productos: ${cart.length}\n🔢 Total de unidades: ${cart.reduce((sum, item) => sum + item.cantidad, 0)}\n\n*He descargado el documento de cotización con las imágenes y detalles de los productos*\n\n¡Gracias por tu solicitud!`;
      
      // Abrir WhatsApp
      window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(message)}`, '_blank');

      alert('¡Cotización descargada! Se ha generado un documento con las imágenes y detalles de los productos. Ahora puedes enviarlo por WhatsApp.');
